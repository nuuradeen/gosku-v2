            ...
            <section className="relative pb-24 sm:pb-32 bg-white dark:bg-black overflow-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        >
                            Building efficiency and automation,{" "}
                            <span className="text-neutral-500 dark:text-neutral-400">
                                with scalability and innovation in mind.
                            </span>
                        </motion.h2>
                        ...
                        >
                            <span className="font-semibold text-neutral-900 dark:text-neutral-100">
                                Lets save you time and money.
                            </span>{" "}
                            With AI, we help you manage your documents and organize your inventory for your business in your favorite 
                            POS system Square.
                        </motion.p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="relative aspect-4/3 overflow-hidden rounded-2xl bg-neutral-100 dark:bg-neutral-900"
                    >
                        <Image
                            src="/images/SquareClayBanks.jpg"
                            alt="Square POS system"
                            fill
